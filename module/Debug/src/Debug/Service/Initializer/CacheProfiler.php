...
class CacheProfiler implements InitializerInterface {
    ...
    public function initialize($instance, ServiceLocatorInterface $serviceLocator)
    {
        if($instance instanceof StorageInterface) {
            ...
            // And we can listen to getItem.pre and getItem.post events
            // to find out if we have cache hit or miss.
            ...
            if(!$this->stats) {
                ...
                // we can store the information into a service called cache-profiler
                $stats = new \stdClass();
                $stats->hits = array();
